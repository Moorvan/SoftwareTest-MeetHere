...
class TestShouldGetExceptionWhenCustomerLoginWithEmptyPasswordAndNewEmail(unittest.TestCase):
  def setUp(self):
  ...
  def test_shouldGetExceptionWhenCustomerLoginWithEmptyPasswordAndNewEmail(self):
