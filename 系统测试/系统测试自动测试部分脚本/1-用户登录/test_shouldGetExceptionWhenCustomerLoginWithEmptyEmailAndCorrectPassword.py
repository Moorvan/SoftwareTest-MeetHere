...
class TestShouldGetExceptionWhenCustomerLoginWithEmptyEmailAndCorrectPassword(unittest.TestCase):
  def setUp(self):
  ...
  def test_shouldGetExceptionWhenCustomerLoginWithEmptyEmailAndCorrectPassword(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").send_keys("customer@qq.com")
