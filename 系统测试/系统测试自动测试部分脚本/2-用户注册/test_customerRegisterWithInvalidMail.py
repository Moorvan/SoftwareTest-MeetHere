...
class TestCustomerRegisterWithInvalidMail(unittest.TestCase):
  def setUp(self):
  ...
  def test_customerRegisterWithInvalidMail(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(1) .el-input__inner").send_keys("hello")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(1) .el-form-item__error").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(1) .el-form-item__error")
