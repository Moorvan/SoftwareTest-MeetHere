...
class TestCustomerRegisterWithExistedMail(unittest.TestCase):
  def setUp(self):
  ...
  def test_customerRegisterWithExistedMail(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(1) .el-input__inner").send_keys("10175101152@stu.ecnu.edu.cn")
    ...
    time.sleep(2)
    assert self.driver.switch_to.alert.text == "发送失败，邮箱可能已被占用"
