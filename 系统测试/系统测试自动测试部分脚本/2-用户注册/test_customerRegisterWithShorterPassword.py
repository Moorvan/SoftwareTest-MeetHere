...
class TestCustomerRegisterWithShorterPassword(unittest.TestCase):
  def setUp(self):
  ...
  def test_customerRegisterWithShorterPassword(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(3) > .el-form-item__content:nth-child(2) .el-input__inner").send_keys("12345")
