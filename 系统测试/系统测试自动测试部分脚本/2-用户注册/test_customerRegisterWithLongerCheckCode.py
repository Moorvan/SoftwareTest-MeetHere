...
class TestCustomerRegisterWithLongerCheckCode(unittest.TestCase):
  def setUp(self):
  ...
  def test_customerRegisterWithLongerCheckCode(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-col .el-input__inner").send_keys("12345678")
