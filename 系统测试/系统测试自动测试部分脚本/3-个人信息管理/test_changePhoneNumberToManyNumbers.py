...
class TestChangePhoneNumberToManyNumbers(unittest.TestCase):
  def setUp(self):
  ...
  def test_changePhoneNumberToManyNumbers(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(4) .el-input__inner").send_keys("12345678987")
