...
class TestChangeUserNameTooLong(unittest.TestCase):
  def setUp(self):
  ...
  def test_changeUserNameTooLong(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".el-message").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".el-message")
    actions = ActionChains(self.driver)
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".is-required .el-input__inner").click()
    self.driver.find_element(By.CSS_SELECTOR, ".is-required .el-input__inner").send_keys("verylongname")
