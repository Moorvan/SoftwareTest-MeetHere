...
class TestTestBrowseCommentList(unittest.TestCase):
  def setUp(self):
  ...
  def test_testBrowseCommentList(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "div:nth-child(23) .clearfix").click()
    self.driver.find_element(By.CSS_SELECTOR, "div:nth-child(23) .clearfix").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, "div:nth-child(23) .clearfix")
